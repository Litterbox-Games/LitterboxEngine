...
public class VulkanPhysicalDevice
{
    ...
    private unsafe VulkanPhysicalDevice(Vk vk, VulkanInstance instance, Silk.NET.Vulkan.PhysicalDevice vkPhysicalDevice)
    {
        _vk = vk;
        Instance = instance;
        ...
        fixed (byte* namePtr = _vkPhysicalDeviceProperties.DeviceName) Name = SilkMarshal.PtrToString((nint)namePtr)!; 
    }
    
    public static unsafe VulkanPhysicalDevice SelectPreferredPhysicalDevice(Vk vk, VulkanInstance instance, string? preferredDeviceName = null)
    {
        ...
        Span<PhysicalDevice> vkPhysicalDevices = new PhysicalDevice[physicalDeviceCount];
        ...
        var supportedDevices = new List<VulkanPhysicalDevice>();
        VulkanPhysicalDevice? selectedPhysicalDevice = null;
        foreach (var vkPhysicalDevice in vkPhysicalDevices)
        {
            var physicalDevice = new VulkanPhysicalDevice(vk, instance, vkPhysicalDevice);
        ...
        selectedPhysicalDevice ??= supportedDevices
            ...
            .FirstOrDefault(supportedDevices.FirstOrDefault((VulkanPhysicalDevice)null!));
    ...
    public uint GetPresentQueueFamilyIndex(VulkanSurface surface)
    {
        var index = VkQueueFamilyProperties
            .Select((_, i) =>
            {
