...
public class VulkanBuffer: Buffer
{
    ...
    public unsafe VulkanBuffer(Vk vk, VulkanLogicalDevice logicalDevice, BufferDescription description, MemoryPropertyFlags properties, VulkanCommandPool commandPool, VulkanQueue queue)
    {
        _vk = vk;
        ...
        _stagingBuffer = new VulkanStagingBuffer(_vk, _logicalDevice, _commandPool, _queue, Size);
    }
