...
public class VulkanTexture : Resources.Texture
{
    public readonly VulkanImageView ImageView;
    private readonly VulkanImage _image;

    public  unsafe VulkanTexture(Vk vk, VulkanLogicalDevice logicalDevice, VulkanCommandPool commandPool, VulkanQueue queue, uint width, uint height,
    ...
    public unsafe VulkanTexture(Vk vk, VulkanLogicalDevice logicalDevice, VulkanCommandPool commandPool, VulkanQueue queue, uint width, uint height, Span<byte> data) : base(width, height)
    {
