...
public class VulkanCommandList: ICommandList
{
    ...
    public unsafe void SetVertexBuffer(ulong offset, Buffer buffer)
    {
    ...
    public unsafe void SetResourceSet(uint set, ResourceSet resourceSet)
    {
