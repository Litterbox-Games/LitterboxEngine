...
public class Image: IDisposable
{
    ...
    public unsafe Image(Vk vk, LogicalDevice logicalDevice, uint width, uint height, Format format, ImageUsageFlags usage)
    {
        _vk = vk;
    ...
    {
        using var commandBuffer = new CommandBuffer(_vk, commandPool, true, true);
